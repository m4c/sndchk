...
Real-time monitoring of system-level audio performance metrics tool for FreeBSD.

`sndchk` monitors audio buffer xruns, USB transfer errors, and interrupt rate spikes, especially for USB DAC devices and music interfaces, to help identify causes of audio glitches and dropouts.
